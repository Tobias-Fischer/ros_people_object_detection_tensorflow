...
_HYPERPARAMS = DESCRIPTOR.message_types_by_name['Hyperparams']
...
_VARIANCESCALINGINITIALIZER = DESCRIPTOR.message_types_by_name['VarianceScalingInitializer']
_RANDOMNORMALINITIALIZER = DESCRIPTOR.message_types_by_name['RandomNormalInitializer']
_BATCHNORM = DESCRIPTOR.message_types_by_name['BatchNorm']
_HYPERPARAMS_OP = _HYPERPARAMS.enum_types_by_name['Op']
_HYPERPARAMS_ACTIVATION = _HYPERPARAMS.enum_types_by_name['Activation']
_VARIANCESCALINGINITIALIZER_MODE = _VARIANCESCALINGINITIALIZER.enum_types_by_name['Mode']
